...
$thanksPage = "https://katayama-law.jp/divorce2/thanks.html";
...
$refrom_name = "片山ひでのり法律事務所";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "法律相談のご予約について";
...
送信していただいた内容は以下のようになります。
この後、こちらから、お電話かメールでご連絡差し上げます。
２、３日経ってもこちらからご連絡がない場合は、恐れ入りますが、お電話かメールでご連絡ください。
